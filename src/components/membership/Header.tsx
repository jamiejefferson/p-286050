...
export const Header: React.FC = () => {
  return (
    <header className="absolute z-0 flex w-[1512px] items-center gap-[40px_100px] justify-between flex-wrap pt-10 pb-6 px-10 right-0 top-[84px] max-md:max-w-full max-md:px-5">
      <div className="self-stretch flex items-center gap-1 text-sm text-black font-gotham whitespace-nowrap leading-[1.2] my-auto">
        <img
      ...
      <img
        ...
        className="aspect-[2.03] object-contain w-[122px] mx-auto shrink-0"
      />
